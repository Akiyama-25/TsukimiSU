...
val defaultManagerPackageName = if (isPrBuild) "Akari.TsukimiSU.pr" else "Akari.TsukimiSU"
val defaultManagerName = if (isPrBuild) "TsukimiSU PR" else "TsukimiSU"
